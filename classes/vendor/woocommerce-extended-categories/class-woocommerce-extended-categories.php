 ...
 */
class Slowfashion_Woocommerce_Extended_Categories {
    ...
    /**
     * class slowfashion_construct. Takes a wp_templater object as a parameter
     *
     * @param Slowfashion_Wp_Templater $templater
     */
    public function __construct( Slowfashion_Wp_Templater $templater ) {
     ...
     * @return boolean
     */
    private function get_checkbox_val( $term_id, $identifier, $default ) {
    ...
    private function render_checkbox( $data, $term_id = null ) {
        ...
        $view = 'add';
        if ( !is_null( $term_id ) ) {
            $checked = $this->get_checkbox_val( $term_id, $data['identifier'], $data['default'] );
            $view = 'edit';
        }

        $this->templater->render( 'checkbox-' . $view, array(
    ...
    private function render_select_list( $data, $term_id = null ) {
        ...
        $this->templater->render( 'select-list-' . $view, array(
            'identifier' => $data['identifier'],
            'label' => $data['label'],
            'description' => $data['description'],
